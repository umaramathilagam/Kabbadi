...
var rand, gameState, plr1score,bg, plr2score, database,position1, position2, reset;
function preload(){
    ...
    bg = loadImage("assests/ground.png");
}
...
function setup(){
    ...
    player1.scale = 0.4;
    player1.debug=true;
    player1.setCollider("circle",0,0,75)
...
function draw(){
    ...
    if(gameState === 1){
        ...
        if(player1.isTouching(player2) || player1.y<0 || player1.y>800){
          database.ref('/').update({
             'gameState':0,
              'player1Score': plr1score + 5,
              'player2Score': plr2score - 5,
      ...
      if(gameState === 2){
        ...
        if(player2.isTouching(player1) || player1.y<0 || player1.y>800){
          database.ref('/').update({
            'gameState':0,
              'player1Score': plr1score - 5,
              'player2Score': plr2score + 5,
    ...
    textSize(15);
    fill("red");
    text("Red score: " + plr1score, 30,50);
    text("Yellow score: " + plr2score, 650,50);
    pop()
